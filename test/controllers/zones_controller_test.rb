...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { abbr: @zone.abbr, isdst: @zone.isdst, offset: @zone.offset, text: @zone.text, value: @zone.value } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { abbr: @zone.abbr, isdst: @zone.isdst, offset: @zone.offset, text: @zone.text, value: @zone.value } }
